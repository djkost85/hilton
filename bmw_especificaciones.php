    ...
    <div class="triumph_content">
    	...
    	<div class="flexiColumn">
                ...
                <table class="motorcycleFullSpecTable" id="motorcyclespecTable">
                        ...
                        <tr>
                        <td class="borderBtm borderRight" rowspan="2">Wheel</td><td class="borderBtm borderRight">Front</td><td class="borderBtm">36-spoke 19 x 2.5in</td>
                        </tr>
                        <tr>
                        <td class="borderBtm borderRight">Rear</td><td class="borderBtm">40-spoke 17 x 3.5in</td>
                        </tr>
                        <tr>
                        <td class="borderBtm borderRight" rowspan="2">Tire</td><td class="borderBtm borderRight">Front</td><td class="borderBtm">100/90 R19</td>
                        </tr>
                        <tr>
                        ...
                        <td class="borderBtm borderRight" rowspan="2">Suspension</td><td class="borderBtm borderRight">Front</td><td class="borderBtm">
                                <p>KYB 41mm forks, 120mm travel</p>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <td class="borderBtm borderRight" rowspan="2">Brakes</td><td class="borderBtm borderRight">Front</td><td class="borderBtm">
                                <p>Single 310mm disc, Nissin 2-piston floating caliper</p>
                            </td>
                        </tr>
                        <tr>
                        <td class="borderBtm borderRight">Rear</td><td class="borderBtm">
