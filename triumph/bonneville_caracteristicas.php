<script type="text/javascript" src="slimbox/js/slimbox2.js"></script>
    	...
    	<table>
        	<tr>
            	...
            	<td class="foto">
                <a href="img/marcas/triumph/bonneville/motor_lb.jpg" rel="lightbox-"> 
                	<img src="img/marcas/triumph/bonneville/motor.jpg" alt="bonneville motor"/>
                </a>
                </td>
            ...
            <tr>
                <td class="foto">
                	<a href="img/marcas/triumph/bonneville/motor_lb.jpg" rel="lightbox-">
                		<img src="img/marcas/triumph/bonneville/suspension.jpg" alt="bonneville suspension"/>
                    </a>   
                    </td>
              ...
              <tr>
                <td class="foto">
                	<a href="img/marcas/triumph/bonneville/tecnologia_lb.jpg" rel="lightbox-">
	                	<img src="img/marcas/triumph/bonneville/tecnologia.jpg" alt="bonneville tecnologia"/>
                    </a>
                </td>
                <td>
                	<h2>TECNOLOGÍA</h2>
